...
export default function HeroSection() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col lg:flex-row items-center justify-center gap-10 my-20 w-full max-w-7xl mx-auto"
    >
      {/* LEFT: 3D Canvas */}
      ...
      {/* RIGHT: Text */}
      <div className="w-full lg:w-1/2 max-w-xl font-poppins space-y-8 px-6 lg:px-12">
