...
import React, { useRef, useEffect } from 'react'  // ← Add useEffect here
import { useGLTF, useAnimations } from '@react-three/drei'

export function Mappin(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('Model/earth_cartoon.glb')
...
useGLTF.preload('/Model/earth_cartoon.glb')
